        ...
        alertDialogBuilder.setPositiveButton("Ok",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        try{
                            DatabaseReference userReference = myDatabase.child(user.getUserID()).child("Messages");
                            userReference.child("body").setValue("FIND_REQUEST");
                            userReference.child("received").setValue(true);
                            userReference.child("sender").setValue(Config.getInstance().userID);
